...
_Stat_Resp::_Stat_Resp(const _Stat_Resp& other0) noexcept {
  _result = other0._result;
  _stat_mode = other0._stat_mode;
  __isset = other0.__isset;
}
_Stat_Resp& _Stat_Resp::operator=(const _Stat_Resp& other1) noexcept {
...
_XLog_Init_File_Resp::_XLog_Init_File_Resp(const _XLog_Init_File_Resp& other2) noexcept {
  _fd = other2._fd;
  _use_existent = other2._use_existent;
  __isset = other2.__isset;
}
_XLog_Init_File_Resp& _XLog_Init_File_Resp::operator=(const _XLog_Init_File_Resp& other3) noexcept {
  _fd = other3._fd;
...
_Smgr_Relation::_Smgr_Relation(const _Smgr_Relation& other4) noexcept {
...
_Smgr_Relation& _Smgr_Relation::operator=(const _Smgr_Relation& other5) noexcept {
