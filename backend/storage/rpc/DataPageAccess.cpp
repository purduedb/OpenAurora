...
DataPageAccess_RpcLStat_args::~DataPageAccess_RpcLStat_args() noexcept {
}


uint32_t DataPageAccess_RpcLStat_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DataPageAccess_RpcLStat_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DataPageAccess_RpcLStat_args");
...
DataPageAccess_RpcLStat_pargs::~DataPageAccess_RpcLStat_pargs() noexcept {
}


uint32_t DataPageAccess_RpcLStat_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DataPageAccess_RpcLStat_pargs");
...
DataPageAccess_RpcLStat_result::~DataPageAccess_RpcLStat_result() noexcept {
}


uint32_t DataPageAccess_RpcLStat_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DataPageAccess_RpcLStat_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("DataPageAccess_RpcLStat_result");
...
DataPageAccess_RpcLStat_presult::~DataPageAccess_RpcLStat_presult() noexcept {
}


uint32_t DataPageAccess_RpcLStat_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
DataPageAccess_RpcMdExist_args::~DataPageAccess_RpcMdExist_args() noexcept {
}


uint32_t DataPageAccess_RpcMdExist_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DataPageAccess_RpcMdExist_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DataPageAccess_RpcMdExist_args");
...
DataPageAccess_RpcMdExist_pargs::~DataPageAccess_RpcMdExist_pargs() noexcept {
}


uint32_t DataPageAccess_RpcMdExist_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("DataPageAccess_RpcMdExist_pargs");
...
DataPageAccess_RpcMdExist_result::~DataPageAccess_RpcMdExist_result() noexcept {
}


uint32_t DataPageAccess_RpcMdExist_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t DataPageAccess_RpcMdExist_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("DataPageAccess_RpcMdExist_result");
...
DataPageAccess_RpcMdExist_presult::~DataPageAccess_RpcMdExist_presult() noexcept {
}


uint32_t DataPageAccess_RpcMdExist_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void DataPageAccessClient::RpcLStat(_Stat_Resp& _return, const _Path& _path)
{
  send_RpcLStat(_path);
  recv_RpcLStat(_return);
}

void DataPageAccessClient::send_RpcLStat(const _Path& _path)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("RpcLStat", ::apache::thrift::protocol::T_CALL, cseqid);

  DataPageAccess_RpcLStat_pargs args;
  args._path = &_path;
  args.write(oprot_);
...
void DataPageAccessClient::recv_RpcLStat(_Stat_Resp& _return)
{
  ...
  if (fname.compare("RpcLStat") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  DataPageAccess_RpcLStat_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "RpcLStat failed: unknown result");
}
...
int32_t DataPageAccessClient::RpcMdExist(const _Smgr_Relation& _reln, const int32_t _forknum)
{
  send_RpcMdExist(_reln, _forknum);
  return recv_RpcMdExist();
}

void DataPageAccessClient::send_RpcMdExist(const _Smgr_Relation& _reln, const int32_t _forknum)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("RpcMdExist", ::apache::thrift::protocol::T_CALL, cseqid);

  DataPageAccess_RpcMdExist_pargs args;
  args._reln = &_reln;
  args._forknum = &_forknum;
  args.write(oprot_);
...
int32_t DataPageAccessClient::recv_RpcMdExist()
{
  ...
  if (fname.compare("RpcMdExist") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  int32_t _return;
  DataPageAccess_RpcMdExist_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "RpcMdExist failed: unknown result");
}
...
void DataPageAccessProcessor::process_RpcLStat(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("DataPageAccess.RpcLStat", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "DataPageAccess.RpcLStat");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "DataPageAccess.RpcLStat");
  }

  DataPageAccess_RpcLStat_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "DataPageAccess.RpcLStat", bytes);
  }

  DataPageAccess_RpcLStat_result result;
  try {
    iface_->RpcLStat(result.success, args._path);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "DataPageAccess.RpcLStat");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("RpcLStat", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "DataPageAccess.RpcLStat");
  }

  oprot->writeMessageBegin("RpcLStat", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "DataPageAccess.RpcLStat", bytes);
  }
}
...
void DataPageAccessProcessor::process_RpcMdExist(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = nullptr;
  if (this->eventHandler_.get() != nullptr) {
    ctx = this->eventHandler_->getContext("DataPageAccess.RpcMdExist", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "DataPageAccess.RpcMdExist");

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preRead(ctx, "DataPageAccess.RpcMdExist");
  }

  DataPageAccess_RpcMdExist_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postRead(ctx, "DataPageAccess.RpcMdExist", bytes);
  }

  DataPageAccess_RpcMdExist_result result;
  try {
    result.success = iface_->RpcMdExist(args._reln, args._forknum);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != nullptr) {
      this->eventHandler_->handlerError(ctx, "DataPageAccess.RpcMdExist");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("RpcMdExist", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->preWrite(ctx, "DataPageAccess.RpcMdExist");
  }

  oprot->writeMessageBegin("RpcMdExist", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != nullptr) {
    this->eventHandler_->postWrite(ctx, "DataPageAccess.RpcMdExist", bytes);
  }
}
...
void DataPageAccessConcurrentClient::RpcLStat(_Stat_Resp& _return, const _Path& _path)
{
  int32_t seqid = send_RpcLStat(_path);
  recv_RpcLStat(_return, seqid);
}

int32_t DataPageAccessConcurrentClient::send_RpcLStat(const _Path& _path)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("RpcLStat", ::apache::thrift::protocol::T_CALL, cseqid);
...
void DataPageAccessConcurrentClient::recv_RpcLStat(_Stat_Resp& _return, const int32_t seqid)
{
...
int32_t DataPageAccessConcurrentClient::RpcMdExist(const _Smgr_Relation& _reln, const int32_t _forknum)
{
  int32_t seqid = send_RpcMdExist(_reln, _forknum);
  return recv_RpcMdExist(seqid);
}

int32_t DataPageAccessConcurrentClient::send_RpcMdExist(const _Smgr_Relation& _reln, const int32_t _forknum)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("RpcMdExist", ::apache::thrift::protocol::T_CALL, cseqid);
...
int32_t DataPageAccessConcurrentClient::recv_RpcMdExist(const int32_t seqid)
{
