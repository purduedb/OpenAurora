...
/*!
 *  This function will firstly create template1 database to /data/1/
 *  Then create some other tables, such like priviledge, system_view, etc. (don't know whether create into /data/1/)
 *  Then copy template1 to template0 and postgres (For this function, it only create two null database).
 */
void
initialize_comp_directory(void)
{
	PG_CMD_DECL;
	int			i;
	 ...
	 *  It seems a Unix Signal Processor.
	 */
	setup_signals();
	...
	/*!
	 *  Only create the directory, doesn't create file.
	 *  If directory is exist, and not empty. Report Error.
	 */
	create_data_directory();

	//! Create db_data/pg_wal/ directory
	 ...
	 * [8] =  "pg_twophase"
	 * [9] =  "pg_multixact"
	 * [10] =  "pg_multixact/members"
	 * [11] =  "pg_multixact/offsets"
	 * [12] =  "base"
	 * [13] =  "base/1"
	 * [14] =  "pg_replslot"
	 * [15] =  "pg_tblspc"
	 ...
	 * [18] =  "pg_xact"
	 * [19] =  "pg_logical"
	 * [20] =  "pg_logical/snapshots"
	 * [21] =  "pg_logical/mappings
	 */
	...
	//! Create empty configure file: db_data/postgresql.conf
	set_null_conf();
    //! Set the dynamic shared memory implementation
	test_config_settings();

	/* Now create all the text config files */
    //!   Create four conf file.
	setup_config();

	/* Bootstrap template1 */
	//! Copy all catalog table's create and insert command to cmdfd
	bootstrap_template1();
	...
	/*!
	 * \"/Users/rainman/pgsql/builted_project/bin/postgres\"
	 * --single -F -O -j -c search_path=pg_catalog -c exit_on_error=true template1 >/dev/null
	 */
	snprintf(cmd, sizeof(cmd),
			 "\"%s\" %s template1 >%s",
	...
	//! Only execute one command "REVOKE ALL on pg_authid FROM public;"
	setup_auth(cmdfd);

	/*!
	 *  Add "insert/delete command of pg_depend and pg_shdepend"
	 *  to cmdfd
	 */
	setup_depend(cmdfd);
	...
	/*!
	 *  Add demands to cmdfd which is related to creating
	 *  system view
	 */
	setup_sysviews(cmdfd);

	//! Insert tuples to pg_description
	setup_description(cmdfd);

	//! Insert tuples to pg_collation
	setup_collation(cmdfd);

	//! Create Dictionary? Don't know what is it.
	setup_dictionary(cmdfd);

	//! Process privilege related staff.
	setup_privileges(cmdfd);

	//! Create information_schema and some function
	setup_schema(cmdfd);
	...
	//! Add command to cmdfd
	//! Only create a void database template0
	make_template0(cmdfd);

	//! Copy template1 to postgres
	//! Only create a void database
	make_postgres(cmdfd);
...
main(int argc, char *argv[])
{
	...
	//! argv[0]: $pwd
	//! argv[1]: -D
	//! argb[2]: /Users/rainman/pgsql/data_dir/db_data
	pg_logging_init(argv[0]);
	progname = get_progname(argv[0]);
	set_pglocale_pgservice(argv[0], PG_TEXTDOMAIN("initcomp"));
	...
	//! "/Users/rainman/pgsql/builted_project/bin/pg_ctl"
	...
	//! start_db_cmd =
	//! /Users/rainman/pgsql/builted_project/bin/pg_ctl -D /Users/rainman/pgsql/data_dir/db_data
