...
#ifndef STORAGE_DSMEngine_PORT_THREAD_ANNOTATIONS_H_
#define STORAGE_DSMEngine_PORT_THREAD_ANNOTATIONS_H_
...
#endif  // STORAGE_DSMEngine_PORT_THREAD_ANNOTATIONS_H_
